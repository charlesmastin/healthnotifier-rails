(function (Patient) {
    "use strict";
    Patient.Models.Procedure = Patient.Models.CollectionItem.extend(
    {
        defaults: _.extend({
            health_event: '',
    ...
    Patient.Collections.Procedure = Patient.Collections.Collection.extend({
        model: Patient.Models.Procedure,
