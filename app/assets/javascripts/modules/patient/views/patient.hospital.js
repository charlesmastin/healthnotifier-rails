(function (Patient, Medication) {
    "use strict";
    Patient.Views.Hospital = Patient.Views.Collection.extend({
        // app.messages.WARNING_DELETE_HOSPITAL
        ...
        addOne: function(model) {
            ...
            var view = new Patient.Views.CollectionItem({model: model, template: _.template($('#hospital-item').html())});
