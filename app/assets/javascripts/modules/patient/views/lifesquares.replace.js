(function(Account, Patient) {
    ...
    Patient.Views.LifesquaresReplace = Backbone.View.extend({
        events: {
            // more than 1 patient
            'click [type="submit"]': 'submitForm',
            'click .cards > article': 'toggleCard',
            'change input.replacement': 'updateFeeDisplay',
        ...
        updateFeeDisplay: function(){
            var cents = $('input.replacement:checked').length * window.COST_PER_PATIENT;
        ...
        submitForm: function(){
            ...
            // scoop the patients
            $('.replacement:checked()').each(function(index, elem){
    ...
    _.extend(Patient.Views.LifesquaresReplace.prototype, Backbone.Session.prototype);
