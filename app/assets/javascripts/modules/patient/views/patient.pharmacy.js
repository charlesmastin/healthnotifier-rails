(function (Patient, Medication) {
    "use strict";
    Patient.Views.Pharmacy = Patient.Views.Collection.extend({
        // app.messages.WARNING_DELETE_PHARMACY
        ...
        addOne: function(model) {
            ...
            var view = new Patient.Views.CollectionItem({model: model, template: _.template($('#pharmacy-item').html())});
